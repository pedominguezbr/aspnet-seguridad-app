<%@ Page Title="" Language="C#" MasterPageFile="~/APPSeguridad.Master" AutoEventWireup="false" CodeBehind="frmPermisoUsuarioBuscar.aspx.cs" Inherits="APP.SEG.WEB.Permisos.frmPermisoUsuarioBuscar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div class="panel">
            <h1 class="rounded">Búsqueda de Permisos de Usuario</h1>
            <br/>
              <table border="0" cellpadding="0" cellspacing="0" class="fix rounded Size700">
                <tbody>
                    ...
                    <tr>
                        <td class="style2">Copiar permisos de</td>
                        <td class="style1">

                            <asp:TextBox ID="txtCodigoUsuarioCopiar" runat="server" CssClass="edit rounded"
                                Width="250px" MaxLength="50"></asp:TextBox>

                        </td>
                        <td class="style3">
                            <asp:Button ID="btnCopiar" runat="server" Text="Copiar"
                                CssClass="btn rounded" ValidationGroup="valPol"
                                onclick="btnCopiar_Click"/>
                            </td>
                         <td>&nbsp</td>
                    </tr>
        ...
        <div>
            ...
            <div class="sub-panel">
                ...
                <h2 style="border-bottom:0px!important;">Permisos Asignados</h2>

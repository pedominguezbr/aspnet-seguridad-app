...
namespace APP.SEG.WEB.Objetos
{
    public partial class frmObjetoBuscar : PaginaBase
    {
        ...
        */
        ...
        //{
        //    SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["APPSeguridad"].ToString());
        ...
        //{
        //    SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["APPSeguridad"].ConnectionString);
